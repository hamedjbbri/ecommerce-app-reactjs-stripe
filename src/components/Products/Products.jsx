 ...
 const products = [
     ...
     { id: 2, name: 'Table', description: 'Living room table.', price:'$15', image: 'http://clipart-library.com/new_gallery/287-2878325_glass-furniture-png-photo-elise-coffee-table.png'},
 ];
